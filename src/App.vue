            ...
            <ul class="menu p-4 w-30 min-h-full bg-gray-800 text-white">
              ...
              <li class="flex flex-col items-center mt-5">
                ...
                >
                  ...
                  <span class="mt-auto text-gray-300">Announce</span>
                </a>
              </li>
              <li class="flex flex-col items-center mt-5">
                <a
                ...
                >
                  ...
                  <span class="mt-auto text-gray-300">Student</span>
                </a>
              </li>
              ...
              <li class="flex flex-col items-center mt-5">
                ...
                >
                  <svg
                    class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-white"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                    ...
                    <path
                      ...
                      stroke-linejoin="round"
                      stroke-width="2"
                      d="M9 17v6h6v-6m-4 2h2m-6 0h2m2-10h2v-2H7v2zm6 0h2v-2h-2v2z"
                    />
                  </svg>
                  <span class="mt-auto text-gray-300">Teacher</span>
                </a>
              </li>
              <li class="flex flex-col items-center mt-5">
                <a
                ...
                >
                  ...
                  <span class="mt-auto text-gray-300">Sign In</span>
                </a>
              </li>
              <li class="flex flex-col items-center mt-5">
                <a
                ...
                >
                  ...
                  <span class="mt-auto text-gray-300">Sign Up</span>
                </a>
              </li>
            </ul>
          </div>
