...
<div class="flex items-center justify-between sm:py-3 z-auto mr-12">
  ...
  <div class="flex">
    ...
    <div class="card w-full =x ml-2 mr-20">
      <div class="card w-full h-full bg-base-100 shadow-2xl mt-5 ml-5 mr-10 border">
      ...
      <div class="card w-full shadow-2xl mt-5 ml-5 mr-10 border">
        ...
        <div class="card-body items-left text-left">
          ...
          <div v-for="course in student?.courses" :key="course.id">
            <div>
              <span
                class="inline-block w-full bg-white border border-gray-400 rounded-md px-3 py-2 text-sm text-gray-800 mt-2 mr-3 mb-3"
              >
