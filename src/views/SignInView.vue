<template>
	<!-- component -->
	<div class="min-h-screen bg-white py-6 flex flex-col justify-center sm:py-12 mr-10">
				...
				<form @submit.prevent="onSubmit">
				  <div class="relative">
					<input
					  ...
					  name="email"
					  type="text"
					  class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 border-t-white border-l-white border-r-white text-gray-900 focus:outline-none focus:border-rose-500"
					  placeholder="Username"
					/>
					<label
					  for="email"
					  class="absolute left-0 -top-3.5 text-gray-600 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-6 peer-focus:text-gray-600 peer-focus:text-sm"
					>Username</label>
				  ...
				  <div class="ml-80">
					<button type="submit" class="w-full bg-gradient-to-r from-red-400 to-orange-500 text-sm text-white rounded-md px-5 py-2 mt-7">LOGIN</button>
				  </div>
				</form>
			  </div>
			</div>
